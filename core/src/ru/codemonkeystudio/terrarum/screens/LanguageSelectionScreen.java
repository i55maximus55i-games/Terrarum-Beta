...
class LanguageSelectionScreen implements Screen {
    ...
    LanguageSelectionScreen(final Terrarum game){
        ...
        langList.addListener(new ClickListener() {
            ...
            public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                ...
                game.bundle = I18NBundle.createBundle(baseFileHandle, locale);
